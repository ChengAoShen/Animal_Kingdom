...
# 训练配置
train_cfg = dict(max_epochs=30, type="EpochBasedTrainLoop", val_begin=1, val_interval=1)
...
param_scheduler = [
    ...
    dict(type="CosineAnnealingLR", T_max=50, eta_min=0, by_epoch=True, begin=1, end=30),
]

auto_scale_lr = dict(base_batch_size=12, enable=None)
load_from = "/root/autodl-tmp/swin-large_checkpoints/5436_6741_5948_4979.pth"
resume = False
